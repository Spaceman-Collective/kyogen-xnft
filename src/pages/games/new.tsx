...
const New = () => {
  ...
  const handleStartGame = async () => {
    ...
    const STARTING_BALANCE = await connection.getBalance(gameWallet?.publicKey);
    // let config = loadGameConfig(ConfigFile)
    // let config: {game_token?:any, tokens_minted?: any} = {}
    ...
    const ix = ixWasmToJs(
      instructionSdk.create_game_instance(newInstanceId, config)
    );
